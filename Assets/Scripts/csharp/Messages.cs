...
namespace Pandora.Messages {
    ...
    static MessagesReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::Pandora.Messages.ServerEnvelope), global::Pandora.Messages.ServerEnvelope.Parser, new[]{ "EnvelopeId", "Start", "Step" }, new[]{ "Message" }, null, null)
          }));
    }
    #endregion
  ...
  #region Messages
  public sealed partial class ReplayFrom : pb::IMessage<ReplayFrom> {
    private static readonly pb::MessageParser<ReplayFrom> _parser = new pb::MessageParser<ReplayFrom>(() => new ReplayFrom());
    private pb::UnknownFieldSet _unknownFields;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pb::MessageParser<ReplayFrom> Parser { get { return _parser; } }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public ReplayFrom(ReplayFrom other) : this() {
      replayFromId_ = other.replayFromId_;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public ReplayFrom Clone() {
      return new ReplayFrom(this);
    }

    /// <summary>Field number for the "replay_from_id" field.</summary>
    public const int ReplayFromIdFieldNumber = 1;
    private long replayFromId_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public long ReplayFromId {
      get { return replayFromId_; }
      set {
        replayFromId_ = value;
      }
    }
    ...
    public override bool Equals(object other) {
      return Equals(other as ReplayFrom);
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool Equals(ReplayFrom other) {
      ...
      if (ReplayFromId != other.ReplayFromId) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (ReplayFromId != 0L) hash ^= ReplayFromId.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      if (ReplayFromId != 0L) {
        ...
        output.WriteInt64(ReplayFromId);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      int size = 0;
      if (ReplayFromId != 0L) {
        size += 1 + pb::CodedOutputStream.ComputeInt64Size(ReplayFromId);
      }
      if (_unknownFields != null) {
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void MergeFrom(ReplayFrom other) {
      if (other == null) {
        return;
      }
      if (other.ReplayFromId != 0L) {
        ReplayFromId = other.ReplayFromId;
      }
  ...
  public sealed partial class Join : pb::IMessage<Join> {
    ...
    public Join(Join other) : this() {
      ...
      replayFromId_ = other.replayFromId_ != null ? other.replayFromId_.Clone() : null;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    /// <summary>Field number for the "replay_from_id" field.</summary>
    public const int ReplayFromIdFieldNumber = 6;
    private global::Pandora.Messages.ReplayFrom replayFromId_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Pandora.Messages.ReplayFrom ReplayFromId {
      get { return replayFromId_; }
      set {
        replayFromId_ = value;
      }
    ...
    public bool Equals(Join other) {
      ...
      if (!object.Equals(ReplayFromId, other.ReplayFromId)) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      ...
      if (replayFromId_ != null) hash ^= ReplayFromId.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (replayFromId_ != null) {
        output.WriteRawTag(50);
        output.WriteMessage(ReplayFromId);
      }
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    ...
    public int CalculateSize() {
      ...
      if (replayFromId_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(ReplayFromId);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(Join other) {
      ...
      if (other.replayFromId_ != null) {
        if (replayFromId_ == null) {
          replayFromId_ = new global::Pandora.Messages.ReplayFrom();
        }
        ReplayFromId.MergeFrom(other.ReplayFromId);
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 50: {
            ...
            input.ReadMessage(replayFromId_);
            break;
          }
        }
      }
  ...
  public sealed partial class ServerEnvelope : pb::IMessage<ServerEnvelope> {
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Pandora.Messages.MessagesReflection.Descriptor.MessageTypes[15]; }
    }
    ...
    /// <summary>Field number for the "envelope_id" field.</summary>
    public const int EnvelopeIdFieldNumber = 4;
    private long envelopeId_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (EnvelopeId != 0L) hash ^= EnvelopeId.GetHashCode();
    ...
    public int CalculateSize() {
      int size = 0;
      if (EnvelopeId != 0L) {
        size += 1 + pb::CodedOutputStream.ComputeInt64Size(EnvelopeId);
      }
      if (messageCase_ == MessageOneofCase.Start) {
